 ...
 private double startTime;
  ...
  //  private 
	...
	private List<String> requiredFiles = null;   // list of required filenames
        private List<Vm> vl=null;
        private List<Integer> vg=null;
	...
	public double getCostPerSec(final int resId) {
        ...
        public List<Vm> setReqdVm(List<Vm> vl1){
            this.vl=vl1;
            return vl;
        }
        public List<Vm> getReqdVm(){
            return vl;
        } 
        public List<Integer> geReqdVmId(){
           vg=new ArrayList<Integer>();
            for(int i=0;i<vl.size();i++){
            vg.add(i, vl.get(i).getId());
            }
            return vg;
        }
  public int getNumVM() {
